...
!(function (t, e) {
    ...
    L = function (t, e) {
      if (S) {
        var n = (function (t) {
          ...
          for (e = 0; e < a; e += 4)
            (n = T[t.charCodeAt(e)]),
              (r = T[t.charCodeAt(e + 1)]),
              (i = T[t.charCodeAt(e + 2)]),
              (o = T[t.charCodeAt(e + 3)]),
              (h[c++] = (n << 2) | (r >> 4)),
              (h[c++] = ((15 & r) << 4) | (i >> 2)),
              (h[c++] = ((3 & i) << 6) | (63 & o));
          return u;
  ...
  function j(t) {
    if (t)
      return (function (t) {
        for (var e in j.prototype) t[e] = j.prototype[e];
        return t;
      })(t);
  }
  (j.prototype.on = j.prototype.addEventListener =
    ...
    (j.prototype.hasListeners = function (t) {
  ...
  function U(t, e) {
    e.useNativeTimers
      ? ((t.setTimeoutFn = D.bind(q)), (t.clearTimeoutFn = F.bind(q)))
      : ((t.setTimeoutFn = q.setTimeout.bind(q)),
        (t.clearTimeoutFn = q.clearTimeout.bind(q)));
  }
  var M,
    V = (function (t) {
      o(i, t);
  ...
  function Z(t) {
    ...
    if (!e)
      try {
        return new q[["Active"].concat("Object").join("X")](
          "Microsoft.XMLHTTP"
        );
      } catch (t) {}
  }
  function tt() {}
  var et = null != new Z({ xdomain: !1 }).responseType,
    nt = (function (t) {
      o(s, t);
      var n = l(s);
      function s(t) {
  ...
  if (
    ((rt.requestsCount = 0), (rt.requests = {}), "undefined" != typeof document)
  )
            ...
            value: function (t) {
              ...
              for (
                var n = function () {
                    var n = t[r],
                      i = r === t.length - 1;
                    O(n, e.supportsBinary, function (t) {
                      try {
                        e.ws.send(t);
                      } catch (t) {}
                      i &&
  ...
  var ut = (function (t) {
              ...
              for (
                var n = function () {
                    ...
                    !(function (t, e) {
                      ...
                      })(n, t) && e.writer.write(Uint8Array.of(54)),
    ...
    ht = { websocket: ct, webtransport: ut, polling: nt },
    ft =
  ...
  function pt(t) {
    ...
    for (var i, o, s = ft.exec(t || ""), a = {}, c = 14; c--; )
      a[lt[c]] = s[c] || "";
    return (
      -1 != n &&
        -1 != r &&
    ...
    function a(n) {
      ...
      return (
        ...
        n
          ...
          : o.host && (o.hostname = pt(o.host).host),
        U(f(r), o),
        (r.secure =
          null != o.secure
            ? o.secure
  ...
  var yt = "function" == typeof ArrayBuffer,
    vt = function (t) {
      return "function" == typeof ArrayBuffer.isView
        ? ArrayBuffer.isView(t)
    ...
    mt =
      "function" == typeof Blob ||
      ("undefined" != typeof Blob &&
        "[object BlobConstructor]" === gt.call(Blob)),
    bt =
      "function" == typeof File ||
      ("undefined" != typeof File &&
        "[object FileConstructor]" === gt.call(File));
  function kt(t) {
    return (
      (yt && (t instanceof ArrayBuffer || vt(t))) ||
  ...
  function wt(e, n) {
    ...
    if (Array.isArray(e)) {
      for (var r = 0, i = e.length; r < i; r++) if (wt(e[r])) return !0;
      return !1;
    }
    if (kt(e)) return !0;
    if (e.toJSON && "function" == typeof e.toJSON && 1 === arguments.length)
      return wt(e.toJSON(), !0);
    for (var o in e)
      if (Object.prototype.hasOwnProperty.call(e, o) && wt(e[o])) return !0;
    return !1;
  }
  function _t(t) {
    var e = [],
      ...
      r = t;
    return (
      (r.data = Ot(n, e)), (r.attachments = e.length), { packet: r, buffers: e }
    );
  }
  function Ot(e, n) {
    if (!e) return e;
  ...
  function At(t, e) {
    return (t.data = Et(t.data, e)), delete t.attachments, t;
  }
  function Et(e, n) {
    if (!e) return e;
    ...
    if (Array.isArray(e)) for (var r = 0; r < e.length; r++) e[r] = Et(e[r], n);
    else if ("object" === t(e))
      for (var i in e)
        Object.prototype.hasOwnProperty.call(e, i) && (e[i] = Et(e[i], n));
    return e;
  }
  var Rt,
    Tt = [
      ...
      r(t, [
        {
          key: "encode",
          value: function (t) {
            return (t.type !== Rt.EVENT && t.type !== Rt.ACK) || !wt(t)
          ...
          [
            {
              ...
              value: function (t) {
                ...
                if ("string" == typeof t) {
                  ...
                  n || e.type === Rt.BINARY_ACK
                    ? ((e.type = n ? Rt.EVENT : Rt.ACK),
        ...
        r(a, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              var i = { type: Rt.EVENT, data: n, options: {} };
              if (
        ...
        r(s, [
          ...
          },
          {
            ...
            value: function (t) {
              ...
              this.engine = new dt(this.uri, this.opts);
              var n = this.engine,
                r = this;
              (this._readyState = "opening"), (this.skipReconnect = !1);
              var i = xt(n, "open", function () {
                  r.onopen(), t && t();
                }),
                o = function (n) {
                  e.cleanup(),
            ...
            value: function (t, e) {
              ...
              return (
                n
                  ...
                  : ((n = new jt(this, t, e)), (this.nsps[t] = n)),
                n
              );
            },
          },
